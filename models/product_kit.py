...
class MateMedicamentGroup(models.Model):
    ...
    mate_kit_line_ids = fields.One2many('mate.product.kit.line', 'mate_kit_id', string='Kit lines')
    description = fields.Text("Description")


class MateProductKitLine(models.Model):
    _name = 'mate.product.kit.line'
    _order = 'sequence asc'
...
class ProductTemplate(models.Model):
    ...
    mate_kit_line_ids = fields.One2many('mate.product.kit.line', 'product_template_id', string='Kit Components')
