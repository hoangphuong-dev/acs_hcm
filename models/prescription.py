...
class MatePrescriptionOrder(models.Model):
    ...
    diseases_ids = fields.Many2many('mate.diseases', 'diseases_prescription_rel', 'diseas_id', 'prescription_id', 
    ...
    physician_id = fields.Many2one('mate_hms.physician', ondelete="restrict", string='Prescribing Doctor',
        default=_current_user_doctor, tracking=1)
    state = fields.Selection([
        ('draft', 'Draft'),
        ('prescription', 'Prescribed'),
        ('canceled', 'Cancelled')], string='Status', default='draft', tracking=1)
    appointment_id = fields.Many2one('mate.appointment', ondelete="restrict", 
        string='Appointment')
    ...
    medical_alert_ids = fields.Many2many('mate.medical.alert', 'prescription_medical_alert_rel','prescription_id', 'alert_id',
...
class MatePrescriptionLine(models.Model):
    ...
    appointment_id = fields.Many2one('mate.appointment', ondelete="restrict", string='Appointment')
