...
class MatePatientDisease(models.Model):
    ...
    disease_id = fields.Many2one('mate.diseases', ondelete='set null', string='Disease')
    ...
    patient_id = fields.Many2one('mate_hms.patient', ondelete='cascade', string='Patient')
...
class PatientGeneticRisk(models.Model):
    ...
    patient_id = fields.Many2one('mate_hms.patient', ondelete='cascade', 
...
class FamilyDiseases(models.Model):
    ...
    patient_id = fields.Many2one('mate_hms.patient', ondelete='cascade', string='Patient', index=True)
    diseases_ids = fields.Many2many('mate.diseases', 'rz_id','pz_id','cz_id' ,'Disease', required=True)
